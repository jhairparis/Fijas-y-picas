          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-gray-400 text-lg leading-relaxed max-w-md">
                Un juego de lógica y deducción que desafiará tu mente. Adivina el número secreto y
                conviértete en el campeón de fijas y picas.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                >
                  <RiGithubFill className="text-gray-400 group-hover:text-rose-400 transition-colors duration-300" size={20} />
                </a>
                <a 
                  href="#" 
                ...
                >
                  <RiInstagramFill className="text-gray-400 group-hover:text-amber-400 transition-colors duration-300" size={20} />
                </a>
                <a 
                  href="#" 
                ...
                >
                  <RiTwitterFill className="text-gray-400 group-hover:text-orange-400 transition-colors duration-300" size={20} />
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-500 text-sm">
              © {new Date().getFullYear()} Fijas y Picas. Todos los derechos reservados.
            </p>
            <div className="flex space-x-6 text-sm">
              <Link href="/terminos" className="text-gray-500 hover:text-gray-300 transition-colors duration-300">
                Términos de Servicio
              </Link>
              <Link href="/privacidad" className="text-gray-500 hover:text-gray-300 transition-colors duration-300">
                Privacidad
              </Link>
            </div>
          </div>
