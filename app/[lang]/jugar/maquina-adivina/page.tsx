...
// Generar metadata para la página Máquina Adivina
...
export default async function MaquinaAdivinaPage({
  params,
}: {
  params: Promise<{ lang: Locale }>;
}) {
  ...
  const gameUrl =
    lang === "es"
      ? `${baseUrl}/jugar/maquina-adivina`
      : `${baseUrl}/${lang}/jugar/maquina-adivina`;
